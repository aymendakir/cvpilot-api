...
Open `/dashboard`, choose **API keys**, save the deployed Laravel URL, and verify it. Then open `/login` and sign in with the seeded admin account. Cross-origin sessions require:
